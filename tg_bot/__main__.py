...
Also, no support can be given for any [clones like this](https://telegram.dog/MissAnn_Bot); source might be changed and that's not my problem [code](https://t.me/Sur_vivor) .
